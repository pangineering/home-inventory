...
class FamiliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family" do
    assert_difference("Family.count") do
      post families_url, params: { family: { fam_id: @family.fam_id, fam_name: @family.fam_name } }
    end
  ...
  test "should update family" do
    patch family_url(@family), params: { family: { fam_id: @family.fam_id, fam_name: @family.fam_name } }
