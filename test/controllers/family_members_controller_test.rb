...
class FamilyMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family_member" do
    assert_difference("FamilyMember.count") do
      post family_members_url, params: { family_member: { dob: @family_member.dob, f_id: @family_member.f_id, gender: @family_member.gender, m_id: @family_member.m_id, name: @family_member.name, role: @family_member.role } }
    end
  ...
  test "should update family_member" do
    patch family_member_url(@family_member), params: { family_member: { dob: @family_member.dob, f_id: @family_member.f_id, gender: @family_member.gender, m_id: @family_member.m_id, name: @family_member.name, role: @family_member.role } }
